            ...
            <div className="w-full max-w-md">
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6 sm:p-8 border border-transparent dark:border-gray-800">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">Crie sua conta</p>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 py-3 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
